...
var MemoryCryptoStore = function () {
    ...
    (0, _createClass3.default)(MemoryCryptoStore, [{
        ...
        value: function getAllEndToEndInboundGroupSessions(txn, func) {
            ...
            try {
                for (var _iterator7 = (0, _getIterator3.default)((0, _keys2.default)(this._inboundGroupSessions)), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
        ...
        value: function unmarkSessionsNeedingBackup(sessions) {
            ...
            try {
                for (var _iterator8 = (0, _getIterator3.default)(sessions), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                    var session = _step8.value;
        ...
        value: function markSessionsNeedingBackup(sessions) {
            ...
            try {
                for (var _iterator9 = (0, _getIterator3.default)(sessions), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
